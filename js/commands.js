document.addEventListener('DOMContentLoaded', function() {
  const translations = {
    ru: {
      ...
      back_button: "Назад",
      auto_bot_button: "Авто-Краш Бот",
      crash_bot_button: "Краш Бот",
  ...
  en: {
    ...
    back_button: "Back",
    auto_bot_button: "Auto-Crash Bot",
    crash_bot_button: "Crash Bot",
  ...
  es: {
    ...
    back_button: "Atrás",
    auto_bot_button: "Bot Auto-Crash",
    crash_bot_button: "Bot de Crash",
    add_bot_button: "Añadir Bot",
  ...
  // Анимация капель (как на главной странице)
  ...
  languageOptions.forEach(option => {
    option.addEventListener('click', () => {
      ...
      languageCurrent.textContent = option.textContent;
